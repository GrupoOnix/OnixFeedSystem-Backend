...
@pytest.fixture
def use_case(mock_group_repo, mock_activity_log_repo):
...
class TestDeleteCageGroup:
    ...
    async def test_delete_existing_group_successfully(self, use_case, mock_group_repo):
        ...
        # Act
        await use_case.execute(group_id, actor="testuser")
    ...
    async def test_delete_fails_when_group_not_found(self, use_case, mock_group_repo):
    ...
    async def test_delete_with_invalid_uuid_format(self, use_case, mock_group_repo):
        ...
        with pytest.raises(ValueError):
            await use_case.execute(invalid_id, actor="testuser")

    async def test_delete_group_with_multiple_cages(self, use_case, mock_group_repo):
    ...
    async def test_delete_is_permanent(self, use_case, mock_group_repo):
    ...
    async def test_delete_does_not_return_value(self, use_case, mock_group_repo):
        ...
        # Act
        result = await use_case.execute(group_id, actor="testuser")

        # Assert: Debe retornar None
        assert result is None

    async def test_delete_group_with_description(self, use_case, mock_group_repo):
    ...
    async def test_delete_verifies_existence_before_deleting(self, use_case, mock_group_repo):
    ...
    async def test_delete_multiple_times_same_id(self, use_case, mock_group_repo):
