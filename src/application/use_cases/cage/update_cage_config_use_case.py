...
from domain.value_objects import CageId, FCR, Volume, Density, FeedingTableId, BlowDurationInSeconds, UserId
...
class UpdateCageConfigUseCase:
    ...
    def __init__(self, cage_repository: ICageRepository, config_change_log_repository: IConfigChangeLogRepository):
        self._cage_repo = cage_repository
        self._config_log_repo = config_change_log_repository

    async def execute(self, cage_id: str, request: UpdateCageConfigRequest, user_id: UserId) -> None:
        """
