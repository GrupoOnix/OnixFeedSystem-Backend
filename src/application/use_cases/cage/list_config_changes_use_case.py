...
from application.dtos.config_dtos import ConfigChangeLogItemResponse, PaginatedConfigChangesResponse, PaginationInfo
...
class ListConfigChangesUseCase:
    ...
    async def execute(self, cage_id: str, limit: int = 50, offset: int = 0) -> PaginatedConfigChangesResponse:
        ...
        log_entries = await self._config_log_repo.list_by_cage(cage_id_vo, limit=limit, offset=offset)
