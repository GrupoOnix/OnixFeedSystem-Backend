...
class NameValidator:
    ...
    @staticmethod
    async def validate_unique_silo_name(name: str, exclude_id: Optional[SiloId], repo: ISiloRepository) -> None:
    ...
    @staticmethod
    async def validate_unique_cage_name(name: str, exclude_id: Optional[CageId], repo: ICageRepository) -> None:
    ...
    @staticmethod
    async def validate_unique_line_name(name: str, exclude_id: Optional[LineId], repo: IFeedingLineRepository) -> None:
